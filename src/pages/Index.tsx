        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Мы — объединение лидеров технологий: ИТР СИНЕРГИЯ ГРУПП (системная
              интеграция), ГК ВЕГА (системы безопасности Keen Vision), B4 System
              Technologies и БифорКом Тек (серверы ST2200 и сетевое
              оборудование). Вместе мы создаем решения для цифровизации и
              автоматизации в Татарстане и по всей России.
            </p>
          </div>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <CardDescription className="text-gray-600">
                  Системный интегратор решений в Татарстане. Электронные очереди
                  ПФР, интеграция интерактивных экранов, диспетчеризация
                  энергорайонов, проекты для Магнит, ФиксПрайс, Furla,
                  Stockmann.
                </CardDescription>
              </CardContent>
            </Card>
